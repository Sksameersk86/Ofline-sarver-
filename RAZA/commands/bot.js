...
module.exports.handleEvent = async function({ api, event }) {
  ...
  if (body && body.trim().toLowerCase() === "bot") {
    ...
    return api.sendMessage("Chup😬 me busy hu apne boss ke sjat 🥱", threadID, messageID);
  }
...
Tum sabse "Topa" bol kar baat karte ho. Har message ka reply sirf 1-2 line me doge, jyada se jyada 20 words me.
...
- Koi emoji bheje to us rulane wali mood me reply dena hai
- Koi tumhe bot kahe to use topa jokar insult kar dena
